...
export interface DashboardData {
  ...
  oil?: OilData;
  unusual_whales?: {
    congress_trades?: import('@shadowbroker/types/unusualWhales').CongressTrade[];
    insider_transactions?: import('@shadowbroker/types/unusualWhales').InsiderTransaction[];
...
export interface MaplibreViewerProps {
  ...
  shodanResults?: import('@shadowbroker/types/shodan').ShodanSearchMatch[];
  shodanStyle?: import('@shadowbroker/types/shodan').ShodanStyleConfig;
}
