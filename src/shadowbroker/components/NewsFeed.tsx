...
import type { SelectedEntity, RegionDossier, FimiData } from "@shadowbroker/types/dashboard";
import { useDataKeys } from '@shadowbroker/hooks/useDataStore';
import { lookupShodanHost } from '@shadowbroker/lib/shodanClient';
import type { ShodanHost } from '@shadowbroker/types/shodan';
    ...
    if (selectedEntity?.type === 'flight' || selectedEntity?.type === 'military_flight' || selectedEntity?.type === 'private_flight' || selectedEntity?.type === 'private_jet') {
        ...
        if (flight) {
            ...
            if (selectedEntity.type === 'military_flight') {
                const mil = flight as import('@shadowbroker/types/dashboard').MilitaryFlight;
